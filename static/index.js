export const images_technologies = [
  {
    "id": 1,
    "label": "Python",
...
export const Boxes = {
    "box1":[
      ...
      },
      {
        ...
        "text": ['Medical', 'Insurance', <br />, '(IPD & OPD)']
      }
    ],
    "box2":[
      {
      ...
      },
      {
        ...
        "text": ["Champion Of The Month", <br />, "Bonus"]
      }
    ],
    "box3":[
      {
        "imgurl": "/backgroundImages/career_page_svgs/Entertainment_Activities.svg",
        "text": ["Entertainment Activities", <br />, "Followed By Bonuses"]
      },
      {
...
export const services_rows_two = {
  "row2":[
    {
...
export const services_rows_three = {
  "row3":[
    {
